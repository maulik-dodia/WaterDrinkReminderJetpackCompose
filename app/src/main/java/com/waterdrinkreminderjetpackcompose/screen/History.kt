...
fun History() {
    Column(
        ...
        Row(
            ...
            RadioButton(
                selected = selectedValue.value == stringResource(id = R.string.label_week),
                onClick = {
                    selectedValue.value = "Week"
                })
            Text(
                text = stringResource(id = R.string.label_week),
                color = Color.Black
            )
            RadioButton(
                selected = selectedValue.value == stringResource(id = R.string.label_Month),
                onClick = {
